...
export const createProduct = async (req, res) => {
  try {
    ...
    if (req.file) {
      const uploadResult = await uploadToCloudinary(req.file.buffer, "productos-tienda", title);
...
export const updateProduct = async (req, res) => {
  try {
    ...
    if (req.file) {
      const uploadResult = await uploadToCloudinary(req.file.buffer, "productos-tienda", title || product.title);
      imageUrl = uploadResult.url;
    }
